...
def process_vector(threshold, output_name):
    ...
    # ImageMagick: Procesar la imagen sin recortar la altura del cráneo.
    # Enmascaramos únicamente los tornillos superiores, el borde superior y todo lo que esté
    # por debajo de Y=630 (donde termina el hocico y empieza el texto).
    cmd_magick = [
        "magick", "original_design.jpg",
        "-colorspace", "gray",
        "-threshold", f"{threshold}%",
        "-fill", "black",
        "-draw", "rectangle 0,0 821,15",            # Borde superior
        "-draw", "rectangle 710,0 821,95",          # Tornillo superior derecho
        "-draw", "rectangle 0,0 80,80",             # Esquina superior izquierda
        "-draw", "rectangle 0,630 821,1024",        # Todo el texto y tornillo inferior
        "-negate",
        bmp_path
    ]
...
# Probamos umbrales de 46%, 48% y 50%
process_vector(46, "logo-craneo-noble-v6-46.svg")
process_vector(48, "logo-craneo-noble-v6-48.svg")
process_vector(50, "logo-craneo-noble-v6-50.svg")
