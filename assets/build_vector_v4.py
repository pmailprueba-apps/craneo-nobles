...
def process_vector(threshold, output_name):
    ...
    # ImageMagick: Procesar la imagen completa.
    # Usamos máscaras tipo túnel (left/right/center-bottom) para remover el texto sin cortar el hocico.
    cmd_magick = [
        ...
        "-draw", "rectangle 0,535 345,1024",        # Columna de texto izquierda ("CRÁNEO" y firmas)
        "-draw", "rectangle 475,535 821,1024",      # Columna de texto derecha ("NOBLE" y firmas)
        "-draw", "rectangle 345,660 475,1024",      # Línea inferior bajo el hocico (tagline)
        "-negate",
        bmp_path
    ]
    ...
    # Para que los cuernos respiren y se vea premium, 530px de ancho es ideal.
    target_w = 530.0
    s = target_w / w_trans
...
# Probamos umbral 48% y 50%
process_vector(48, "logo-craneo-noble-v3-48.svg")
process_vector(50, "logo-craneo-noble-v3-50.svg")
process_vector(52, "logo-craneo-noble-v3-52.svg")
