...
def process_vector(threshold, output_name):
    ...
    # ImageMagick: Procesar la imagen completa con el túnel ultra estrecho (X=380 a X=440)
    # y comenzando la máscara lateral más arriba (Y=510) para asegurar de borrar toda la tipografía.
    cmd_magick = [
        ...
        "-draw", "rectangle 0,510 380,1024",        # Columna de texto izquierda ("CRÁNEO" y firmas)
        "-draw", "rectangle 440,510 821,1024",      # Columna de texto derecha ("NOBLE" y firmas)
        "-draw", "rectangle 380,665 440,1024",      # Línea inferior bajo el hocico (tagline)
        "-negate",
        bmp_path
    ]
    
    print(f"Ejecutando ImageMagick para umbral {threshold}% con túnel estrecho...")
...
process_vector(48, "logo-craneo-noble-v4-48.svg")
process_vector(50, "logo-craneo-noble-v4-50.svg")
process_vector(52, "logo-craneo-noble-v4-52.svg")
